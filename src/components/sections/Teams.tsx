...
const teamMembers = [
  ...
  },
  {
    ...
    name: "StarGel",
    role: "Server Coder",
    avatar: "/images/team/ubidev.jpeg",
    color: "#3B82F6",
    stats: "02",
    icon: Code,
  ...
  },
  {
    ...
    avatar: "/images/team/sirbuz.jpeg",
    color: "#A855F7",
    stats: "05",
    icon: Users,
...
export default function Teams() {
  ...
  return (
    <section
      id="teams"
      className="py-24 bg-linear-to-b from-black to-[#0a0a0a] relative flex items-center justify-center overflow-hidden"
    >
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 z-0 h-full w-full">
                  ...
                  <div
                    className={`absolute inset-0 bg-linear-to-t from-black via-black/40 to-transparent transition-opacity duration-500 ${isActive ? "opacity-90" : "opacity-80"}`}
                  />
                ...
                {/* Border Glow Active */}
                <div
                  className={`absolute inset-0 border-2 rounded-3xl pointer-events-none transition-all duration-500 ${isActive ? "border-white/10" : "border-transparent"}`}
