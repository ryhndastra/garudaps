  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none will-change-[opacity]">
        <div
          className={`absolute inset-[-50%] animate-[spin_3s_linear_infinite] bg-linear-to-r ${gradientColor} via-transparent to-transparent blur-3xl opacity-30 transform-gpu`}
        />
      </div>
    ...
    <section id="features" className="relative py-24 overflow-hidden">
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        <div className="mb-20 max-w-3xl">
          ...
          >
            Server{" "}
            <span className="animate-gradient-text border-b-4 border-orange-500 pb-1">
              Features.
            </span>
          </motion.h2>

          <p className="text-white/50 text-lg font-light leading-relaxed max-w-xl">
            Features built for the real Growtopians. Optimized for farming,
            trading, and stability.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
          {/* STARTER PACK */}
          <UltraCard
            className="md:col-span-4 min-h-60"
            gradientColor="from-cyan-500 via-blue-500 to-purple-500"
          >
              ...
              <div className="space-y-4 max-w-md">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm leading-relaxed font-medium">
                    Login for the first time and receive{" "}
          ...
          <UltraCard
            ...
            gradientColor="from-yellow-500 via-orange-500 to-red-500"
          >
          ...
          {/* CUSTOM ITEMS */}
          <UltraCard
            className="md:col-span-3 min-h-45"
            gradientColor="from-purple-500 via-pink-500 to-rose-500"
          >
          ...
          <UltraCard
            className="md:col-span-3 min-h-45"
            gradientColor="from-emerald-500 via-green-500 to-lime-500"
          >
            <div className="flex items-center gap-5 h-full relative z-10">
              ...
              <div>
                ...
                <p className="text-white/50 text-sm leading-snug">
                  Easy <span className="text-green-400 font-bold">Profit</span>{" "}
                  by doing Fishing, Farming, and Trading.
                </p>
              </div>
            </div>
          </UltraCard>
          ...
          <UltraCard
            className="md:col-span-2 min-h-40"
            gradientColor="from-blue-500 via-indigo-500 to-violet-500"
          >
            <div className="h-full flex flex-col justify-center relative z-10">
              ...
              <p className="text-white/40 text-xs mt-1">
                Play seamlessly on PC, Android, and iOS.
              </p>
            </div>
          </UltraCard>
          ...
          <UltraCard
            className="md:col-span-2 min-h-40"
            gradientColor="from-yellow-400 via-orange-500 to-amber-500"
          >
            <div className="h-full flex flex-col justify-center relative z-10">
              ...
              <p className="text-white/40 text-xs mt-1">
                Balanced market. No hyper-inflation.
              </p>
            </div>
          </UltraCard>
        </div>
